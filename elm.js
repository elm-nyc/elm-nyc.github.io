...
var _user$project$Main$fontStyles = {
	ctor: '::',
		...
		if (_p1.ctor === 'Ok') {
			return {
				...
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{
						nextMeetup: _elm_lang$core$Maybe$Just(_p1._0)
					}),
			...
			return {
				...
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{nextMeetup: _elm_lang$core$Maybe$Nothing}),
				_1: _elm_lang$core$Platform_Cmd$none
			};
		}
	});
...
var _user$project$Main$Meetup = F3(
	function (a, b, c) {
		return {name: a, link: b, time: c};
	});
var _user$project$Main$meetupDecoder = A2(
	_elm_lang$core$Json_Decode$index,
	0,
	A4(
		_elm_lang$core$Json_Decode$map3,
		_user$project$Main$Meetup,
...
var _user$project$Main$UpdateMeetup = function (a) {
	return {ctor: 'UpdateMeetup', _0: a};
};
var _user$project$Main$fetchMeetup = A2(
	_elm_lang$http$Http$send,
	_user$project$Main$UpdateMeetup,
	A2(_elm_lang$http$Http$get, 'http://api.meetup.com/Elm-NYC/events', _user$project$Main$meetupDecoder));
var _user$project$Main$None = {ctor: 'None'};
var _user$project$Main$FooterLink = {ctor: 'FooterLink'};
var _user$project$Main$FooterText = {ctor: 'FooterText'};
var _user$project$Main$Footer = {ctor: 'Footer'};
var _user$project$Main$DescriptionLink = {ctor: 'DescriptionLink'};
var _user$project$Main$Description = {ctor: 'Description'};
var _user$project$Main$meetupView = function (model) {
	var _p2 = model.nextMeetup;
	if (_p2.ctor === 'Just') {
		var _p3 = _p2._0;
		return A3(
			...
			{
				ctor: '::',
				_0: _mdgriffith$style_elements$Element$text('Sign up for our next meetup: '),
				_1: {
					ctor: '::',
					_0: A2(
						...
						A3(
							...
							_mdgriffith$style_elements$Element$text(_p3.name))),
					_1: {ctor: '[]'}
				}
			});
	} else {
		return A3(
			...
			{
				ctor: '::',
				_0: _mdgriffith$style_elements$Element$text('No upcoming meetups have been scheduled yet. Stay tuned!'),
				_1: {ctor: '[]'}
			});
	}
};
	...
	return A2(
		...
		A3(
			...
			_user$project$Main$None,
			{
				...
				_1: {
					ctor: '::',
					_0: A2(_mdgriffith$style_elements$Element_Attributes$paddingXY, 120, 0),
					_1: {ctor: '[]'}
				}
			},
			{
					...
					},
					{
						...
						_1: {
							...
							_0: A3(
								...
								_user$project$Main$Title,
								{ctor: '[]'},
								_mdgriffith$style_elements$Element$text('elm-nyc')),
							_1: {
								ctor: '::',
								_0: A3(
									_mdgriffith$style_elements$Element$paragraph,
									...
									{
										ctor: '::',
										_0: _mdgriffith$style_elements$Element$text('welcome! join us on '),
										_1: {
											ctor: '::',
											_0: A2(
												_mdgriffith$style_elements$Element$link,
												'http://elmnyc.herokuapp.com/',
												A3(
													_mdgriffith$style_elements$Element$el,
													_user$project$Main$DescriptionLink,
													{
													...
													_mdgriffith$style_elements$Element$text('slack'))),
											_1: {
												ctor: '::',
												_0: _mdgriffith$style_elements$Element$text(' or at our '),
												_1: {
													ctor: '::',
													_0: A2(
														_mdgriffith$style_elements$Element$link,
														'https://www.meetup.com/Elm-NYC/',
														A3(
															_mdgriffith$style_elements$Element$el,
															_user$project$Main$DescriptionLink,
															{
								...
								_1: {
									ctor: '::',
									_0: _user$project$Main$meetupView(model),
									_1: {ctor: '[]'}
								}
							}
						}
					...
					_0: A3(
							...
							_1: {
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: _mdgriffith$style_elements$Element_Attributes$height(
											_mdgriffith$style_elements$Element_Attributes$px(75)),
										_1: {ctor: '[]'}
									}
								}
							}
						},
						{
							...
							_0: A3(
								...
								{
									ctor: '::',
									_0: _mdgriffith$style_elements$Element$text('contact: ( '),
									_1: {
										ctor: '::',
										_0: A2(
											_mdgriffith$style_elements$Element$link,
											'mailto:krbernet@gmail.com',
											A3(
												_mdgriffith$style_elements$Element$el,
												_user$project$Main$FooterLink,
												{ctor: '[]'},
												_mdgriffith$style_elements$Element$text('kara'))),
										_1: {
											ctor: '::',
											_0: _mdgriffith$style_elements$Element$text(', '),
											_1: {
												...
												_0: A2(
													_mdgriffith$style_elements$Element$link,
													'mailto:noahzacharygordon@gmail.com',
													A3(
														_mdgriffith$style_elements$Element$el,
														_user$project$Main$FooterLink,
														{ctor: '[]'},
														_mdgriffith$style_elements$Element$text('noah'))),
												_1: {
													ctor: '::',
													_0: _mdgriffith$style_elements$Element$text(' )'),
													_1: {ctor: '[]'}
...
var _user$project$Main$main = _elm_lang$html$Html$program(
	{
		init: {
			ctor: '_Tuple2',
			_0: {nextMeetup: _elm_lang$core$Maybe$Nothing},
			_1: _user$project$Main$fetchMeetup
		},
